...
function Register({
  ...
  return (
    <section>
      ...
      <button onClick={() => handleSubmit()} className='mt-12 flex w-full items-center justify-center rounded-half bg-blue-high px-20 py-3 text-dim-black hover:bg-blue-high/80 md:w-auto'>
        Register
      </button>
    </section>
  );
    ...
    fetch("http://127.0.0.1:5000/register", {
      ...
      .then((data) => {
        ...
        if (data.status === "ok") {
          ...
          console.error("Registration failed:", data.error); // Log error details
          window.localStorage.setItem("messageType", "danger");
          setPopupMessage(data.error);
        }
      })
